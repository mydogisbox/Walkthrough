...
_Current version: 1.0.7. Upgrading from 0.6.x? See [upgrade-0.6-to-0.7.md](upgrade-0.6-to-0.7.md). Upgrading from 0.5.x? See [upgrade-0.5-to-0.6.md](upgrade-0.5-to-0.6.md). Upgrading from 0.4.0? See [upgrade-0.4-to-0.5.md](upgrade-0.4-to-0.5.md). Upgrading from 0.3.0? See [upgrade-0.3-to-0.4.md](upgrade-0.3-to-0.4.md)._
